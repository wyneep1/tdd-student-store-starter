...
import "./Sidebar.css"
export default function Sidebar({isOpen, shoppingCart, products, checkOutForm, handleOnCheckoutFormChange, handleOnSubmitCheckoutForm, handleOnToggle, setIsOpen, order, makeReceipt, setMakeReceipt,checkingOutError}) {
  return (
    <section className={isOpen ? "sidebar" : "sidebar closed"}>
      ...
      <ShoppingCart isOpen={isOpen} setIsOpen={setIsOpen} products={products} shoppingCart={shoppingCart} checkOutForm={checkOutForm} handleOnCheckoutFormChange={handleOnCheckoutFormChange} handleOnSubmitCheckoutForm={handleOnSubmitCheckoutForm} order={order} makeReceipt={makeReceipt} setMakeReceipt={setMakeReceipt} checkingOutError={checkingOutError}/>
    </section>
  )
}
